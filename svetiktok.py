...
def fast_mp3_api():
    ...
    # Aturan 3: Streaming proxy biner dengan User-Agent browser agar tidak diblokir CDN
    try:
        req_headers = {
        ...
        # Aturan 4: Generator internal yield chunk sebesar 1024 * 64 bytes
        def generate():
            for chunk in r.iter_content(chunk_size=1024 * 64):
                if chunk:
                    yield chunk

        # Aturan 5 & 6: Kembalikan Response stream_with_context dengan header Content-Type dan Content-Disposition
        return Response(
